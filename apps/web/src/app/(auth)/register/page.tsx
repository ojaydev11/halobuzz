  ...
  return (
    <main className="max-w-md mx-auto p-6 space-y-4">
      ...
      <form onSubmit={onSubmit} className="space-y-3">
        <input className="w-full p-2 rounded bg-gray-800" placeholder="Display name" value={displayName} onChange={e => setDisplayName(e.target.value)} />
        ...
        <button className="w-full bg-purple-600 hover:bg-purple-500 rounded p-2">Sign up</button>
      </form>
    </main>
  );
}
